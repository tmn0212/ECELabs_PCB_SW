...
def setIO():
    ...
    bus.write_i2c_block_data(0x20, 0x00, [0x00, 0x00, 0x00, 0x00]) # 0x20 is an output device so IODIR=0
    bus.write_i2c_block_data(0x21, 0x00, [0x00, 0x00, 0x00, 0x00]) # 0x21 is an output device so IODIR=0
    bus.write_i2c_block_data(0x22, 0x00, [0xFF, 0xFF, 0x00, 0x00])
    ...
    bus.write_i2c_block_data(0x27, 0x00, [0x7F, 0xFF, 0x00, 0x00]) # 0x7F is because we don't need PB20 as input
